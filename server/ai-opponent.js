...
function buildAIMessages({ levelKey, topic, phase, sideName, history, styleProfile }) {
  ...
  const system = [
    ...
    lv.title === '初级' ? '你的表达应略显直白稚嫩、偶尔论据不严密，像辩论新手。' : lv.title === '大师' ? '你的表达犀利老练，善于抓住对方逻辑漏洞并快速反击，引用具体事实或公认常识，节奏感强。' : '你的表达套路清晰，论点-论据-例子三步推进，偶尔会反问施压。',
